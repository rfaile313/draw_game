...
PUSHD Build
%COMPILER% %SOURCE% -o %EXECUTABLE% %CFLAGS% %INCLUDEPATHS% %LIBPATHS% %LIBFLAGS% && echo **Build Successful. Running.** && echo. && %EXECUTABLE%
POPD
GOTO:EOF
...
IF NOT EXIST Debug echo. && echo **No build directory at the moment**

...
:: ------------TO USE THIS YOU HAVE TO ADD THE RAYLIB FOLDER TO THE WIN DIR----------
...
IF NOT EXIST Build MKDIR Build
PUSHD Build
call %VCVARSALL% x64 && copy %COPYDLL% && %COMPILER% %CFLAGS% && echo. && echo %SUCCESS% && echo. && remedybg.exe %EXECUTABLE%.exe
POPD
GOTO:EOF 
